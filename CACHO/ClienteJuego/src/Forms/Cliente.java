...
public class Cliente extends javax.swing.JFrame {
            ...
            public void onRead(String mensaje){
                ...
                switch(msj[2]){
                    ...
                    case constNames.ES_TU_TURNO:
                        ...
                        canTirosRealizados=0;
                        break;
                    case constNames.NO_ES_TU_TURNO:
                        enTurno=false;
    ...
    private void initComponents() {
        ...
        imagenDado1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Forms/Dado1.png"))); // NOI18N
        ...
        imagenDado2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Forms/Dado1.png"))); // NOI18N
        ...
        imagenDado3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Forms/Dado1.png"))); // NOI18N
        ...
        imagenDado4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Forms/Dado1.png"))); // NOI18N
        ...
        imagenDado5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Forms/Dado1.png"))); // NOI18N
    ...
    private void botonLanzarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonLanzarActionPerformed
        ...
        if (canTirosRealizados <= 2) {
            ...
            cliente.sendMensaje(constNames.GENERAR_DADOS + "_" + cad);
        } else if (canTirosRealizados == 3) {
            cliente.sendMensaje(constNames.TERMINE);
            botonLanzar.setEnabled(false);
            botonLanzar.setText("LANZAR DADOS");
        }
    }//GEN-LAST:event_botonLanzarActionPerformed
    public void setCubilete(String cubi){
        Gson json=new Gson();
        cubilete=json.fromJson(cubi, Cubilete.class);
    }
    public void mostrarGif(){
        ImageIcon image = new ImageIcon(getClass().getResource(("GIFMezcla.gif")));
    ...
    private void imagenDado1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_imagenDado1MouseClicked
        ...
        if(enTurno)actualizarImagenDado(1);
    ...
    private void imagenDado2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_imagenDado2MouseClicked
        // TODO add your handling code here:
        if(enTurno)actualizarImagenDado(2);
    ...
    private void imagenDado3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_imagenDado3MouseClicked
        // TODO add your handling code here:
        if(enTurno)actualizarImagenDado(3);
    ...
    private void imagenDado4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_imagenDado4MouseClicked
        // TODO add your handling code here:
        if(enTurno)actualizarImagenDado(4);
    ...
    private void imagenDado5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_imagenDado5MouseClicked
        // TODO add your handling code here:
        if(enTurno)actualizarImagenDado(5);
    ...
    //Si altera valores-Si altera tamaños
    public void mostrarDadosIniciales(){
        ImageIcon image;ImageIcon icon;
        image = new ImageIcon(getClass().getResource(("Dado1.png")));
        icon = new ImageIcon(image.getImage().
                getScaledInstance(tamGrande, tamGrande, Image.SCALE_DEFAULT));
        imagenDado1.setIcon(icon);
        
        image = new ImageIcon(getClass().getResource(("Dado2.png")));
        icon = new ImageIcon(image.getImage().
                getScaledInstance(tamGrande, tamGrande, Image.SCALE_DEFAULT));
        imagenDado2.setIcon(icon);
        
        image = new ImageIcon(getClass().getResource(("Dado3.png")));
        icon = new ImageIcon(image.getImage().
                getScaledInstance(tamGrande, tamGrande, Image.SCALE_DEFAULT));
        imagenDado3.setIcon(icon);
        
        image = new ImageIcon(getClass().getResource(("Dado4.png")));
        icon = new ImageIcon(image.getImage().
                getScaledInstance(tamGrande, tamGrande, Image.SCALE_DEFAULT));
        imagenDado4.setIcon(icon);
        
        image = new ImageIcon(getClass().getResource(("Dado5.png")));
        icon = new ImageIcon(image.getImage().
                getScaledInstance(tamGrande, tamGrande, Image.SCALE_DEFAULT));
    ...
    public void todasImagenesPeque() {
        ...
        image = new ImageIcon(getClass().
                getResource(("Dado" + cubilete.getDado(0).getValor() + ".png")));
        icon = new ImageIcon(image.getImage().getScaledInstance(
                tamPeque, tamPeque, Image.SCALE_DEFAULT));
        imagenDado1.setIcon(icon);
        
        image = new ImageIcon(getClass().
                getResource(("Dado" + cubilete.getDado(1).getValor() + ".png")));
        icon = new ImageIcon(image.getImage().getScaledInstance(
                tamPeque, tamPeque, Image.SCALE_DEFAULT));
        imagenDado2.setIcon(icon);
        
        image = new ImageIcon(getClass().
                getResource(("Dado" + cubilete.getDado(2).getValor() + ".png")));
        icon = new ImageIcon(image.getImage().getScaledInstance(
                tamPeque, tamPeque, Image.SCALE_DEFAULT));
        imagenDado3.setIcon(icon);
        
        image = new ImageIcon(getClass().
                getResource(("Dado" + cubilete.getDado(3).getValor() + ".png")));
        icon = new ImageIcon(image.getImage().getScaledInstance(
                tamPeque, tamPeque, Image.SCALE_DEFAULT));
        imagenDado4.setIcon(icon);
        
        image = new ImageIcon(getClass().
                getResource(("Dado" + cubilete.getDado(4).getValor() + ".png")));
        icon = new ImageIcon(image.getImage().getScaledInstance(
                tamPeque, tamPeque, Image.SCALE_DEFAULT));
        imagenDado5.setIcon(icon);
    }
    ...
    public void actualizarDados() {
        ...
        if(!cubilete.getDado(0).fueElegido()){
            image = new ImageIcon(getClass().getResource(
                    ("Dado" + cubilete.getDado(0).getValor() + ".png")));
            icon = new ImageIcon(image.getImage().getScaledInstance(
        ...
        if(!cubilete.getDado(1).fueElegido()){
            image = new ImageIcon(getClass().getResource(
                    ("Dado" + cubilete.getDado(1).getValor() + ".png")));
            icon = new ImageIcon(image.getImage().getScaledInstance(
                     tamGrande,tamGrande,Image.SCALE_DEFAULT));
        }else{
            image = new ImageIcon(getClass().getResource(
        ...
        if(!cubilete.getDado(2).fueElegido()){
            image = new ImageIcon(getClass().getResource(
                    ("Dado" + cubilete.getDado(2).getValor() + ".png")));
            icon = new ImageIcon(image.getImage().getScaledInstance(
                     tamGrande,tamGrande,Image.SCALE_DEFAULT));
        }else{
            image = new ImageIcon(getClass().getResource(
        ...
        if(!cubilete.getDado(3).fueElegido()){
            image = new ImageIcon(getClass().getResource(
                    ("Dado" + cubilete.getDado(3).getValor() + ".png")));
            icon = new ImageIcon(image.getImage().getScaledInstance(
                     tamGrande,tamGrande,Image.SCALE_DEFAULT));
        }else{
            image = new ImageIcon(getClass().getResource(
        ...
        if(!cubilete.getDado(4).fueElegido()){
            image = new ImageIcon(getClass().getResource(
                    ("Dado" + cubilete.getDado(4).getValor() + ".png")));
            icon = new ImageIcon(image.getImage().getScaledInstance(
                     tamGrande,tamGrande,Image.SCALE_DEFAULT));
        }else{
            image = new ImageIcon(getClass().getResource(
